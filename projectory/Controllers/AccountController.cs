...
namespace projectory.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IApplicationUserManagerFacade applicationUserManager,
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError(string.Empty, ErrorMessages.InvalidLoginAtempt);
                    return View(model);
            }
        }

        // GET: /Account/RegisterAsANewUser
        [AllowAnonymous]
        ...
        //
        // POST: /Account/RegisterAsANewUser
        [HttpPost]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        ...
        public async Task<ActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            return View(result.Succeeded ? AccountActions.ConfirmEmail : ErrorMessages.Error);
        }
        ...
        {
            return code == null ? View(ViewNames.Error) : View();
        }
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user == null)
            {
                ...
                return RedirectToAction(AccountActions.ResetPasswordConfirmation, ControllerNames.Account);
            }
